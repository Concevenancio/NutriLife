...
const actualizarPaciente = async (req, res) => {
    ...
    paciente.fechavencimiento = req.body.fechavencimiento || paciente.fechavencimiento;
    paciente.fechainiciopaquete = req.body.fechainiciopaquete || paciente.fechainiciopaquete;
